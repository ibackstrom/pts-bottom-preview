...
const CONFIG = {
  ...
  cornerRadius: 0.17,       // AURORA ver6: bigger — the cloud has to WRAP the pressed tab
  ...
  attractCore: 0.50,        // AURORA ver6: wide core — the cloud stays HOLLOW, the tab text sits
                            //   inside it readable instead of buried
  ...
  alphaGain: 0.36,          // AURORA ver6: haze around the words rather than paint over them
