...
const CONFIG = {
  ...
  particleSize: 1.33,        // sphere diameter, world units, before the per-mote multiplier
  ...
  cornerRadius: 0.065,       // AURORA ver7: smaller than the CTA's 0.14 — the customer asked
  ...
  silhouette: 1.25,          // long-to-across ratio of the streak. 1 is a circle
...
function glideSeats(dt) {
  ...
  const targetOffsetX = csx * targetWorldX / vhGlide + 0.190
